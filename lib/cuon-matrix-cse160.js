...
// JSDoc source: https://jsdoc.app/tags-param.html
...
class Vector3 {
  ...
  div(scalar) {
    if(scalar == 0) {
      console.warn("Attempted to divide by 0");
      return;
    }
    // Insert your code here.
    // This function should change this vector (this.elements) and not create a new vector.
  ...
  /**
    ...
    * @param {Vector3} other1
    * @param {Vector3} other2
    * @return scalar
    */
  ...
  static cross(other1, other2) {
    ...
    const a = other1.elements, b = other2.elements;
    const components = [
    ...
    // Store the cross product in a new vector v3
    let v3 = new Vector3(components);
  ...
  /**
    ...
    * @return scalar
    * 
    * Source: https://www.cuemath.com/magnitude-of-a-vector-formula/
    */
  magnitude() {
      // Insert your code here.
      let m = 0;
